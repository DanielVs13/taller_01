...
import 'package:taller_01/screens/series.dart';
...
class _PeliState extends State<Peliculas> {
  int indice = 0;
  ...
  Widget build(BuildContext context) {
    List<Widget> screens = [
      Lista(),
      Series()
    ]; // Agrega Series() si está implementado
    return MaterialApp(
        ...
        bottomNavigationBar: BottomNavigationBar(
          ...
          items: const [
            BottomNavigationBarItem(
                icon: Icon(Icons.headphones), label: "Películas"),
            BottomNavigationBarItem(
                icon: Icon(Icons.add_link), label: "Series"),
          ],
        ),
      ),
    );
      ...
      body: Column(
        ...
        children: <Widget>[
          Container(
            height: 200,
            color:
                Color.fromARGB(255, 11, 0, 13), // Color morado para la galería
